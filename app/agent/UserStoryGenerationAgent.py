...
class UserStoryAgent:
    def __init__(self, llm):
        ...
        You are an expert API architect and business analyst. Analyze the following Swagger/OpenAPI specification 
        and provide a comprehensive, detailed analysis that tells the story of this API ecosystem.
        
        Swagger Content: {swagger_content}
        
        Please provide a thorough analysis with rich details and context:
        ...
        Format your response as structured JSON with rich, detailed explanations for each section.
        Use narrative descriptions that tell the story behind the technical details.
        Include specific examples from the API specification to support your analysis.
        """)
    ...
    async def analyze(self, state: WorkflowState) -> WorkflowState:
        ...
        try:
            ...
            print("✅ Raw AI Response Generated")
